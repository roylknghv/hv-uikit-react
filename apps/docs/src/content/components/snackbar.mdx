...
<Header
  ...
  controls={{
    title: { defaultValue: "Snackbar Title" },
    ...
    size: { defaultValue: "regular", values: ["regular", "toast"] },
  }}
  componentProps={{
...
> [!TIP]
>
> Check out our [snackbar examples](/examples/notifications)!
...
You can customize the `Snackbar` by setting its position, transition direction or the auto-hide duration.
...
export default function Demo() {
  ...
  return (
    <div className="flex justify-center w-full">
      <HvSnackbar
        open={open}
        title={anchorOrigin.vertical + " " + anchorOrigin.horizontal}
      ...
      <div className="flex flex-col gap-md">
        <div className="w-full flex justify-between gap-xs items-end">
          <HvSelect
